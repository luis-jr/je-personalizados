...
namespace systemJE\Http\Controllers;

use Illuminate\Http\Request;
use systemJE\Entrada;
use systemJE\DetalheEntrada;
use Illuminate\Support\Facades\Redirect;
use systemJE\Http\Requests\EntradaFormRequest;
use DB;
...
class EntradaController extends Controller
{
    ...
    public function create(){
        ...
        $produtos=DB::table('produto as pro')
            ->select(DB::raw('pro.nome As produto'), 'pro.idproduto')
    ...
    public function store(EntradaFormRequest $request){
        ...
        try{
            ...
            $mytime = Carbon::now('America/Manaus');
