...
@section('conteudo')
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <h3>Editar Fornecedore: {{$pessoa->nome}}</h3>
            @if (count($errors)>0)
            ...
            {!!Form::model($pessoa, ['method'=>'PATCH', 'route'=>['fornecedor.update', $pessoa->idpessoas]])!!}
            {{Form::token()}}
    <div class="row">
        ...
        <div class="col-lg-6 col-sm-6 col-xs-12">
            <div class="form-group">
                ...
                <input type="text" name="num_doc" required value="{{$pessoa->num_doc}}" class="form-control" placeholder="Número do Documento...">
            </div>
        ...
        <div class="col-lg-6 col-sm-6 col-xs-12">
            <div class="form-group">
                ...
                <input type="text" name="email"
                       value="{{$pessoa->email}}" class="form-control">
            </div>
